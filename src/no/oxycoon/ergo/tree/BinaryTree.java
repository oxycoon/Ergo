...
public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
	...
	public boolean insert(E object, E parent)
	{
		if (root == null)
			root = createNewNode(object);
		else
		{
			TreeNode<E> _parent = null;
			TreeNode<E> _current = root;
			
			while(_current != null)
			{
				if(object.compareTo(_current.element) < 0)
				{
	...
	/** Legger til preorder og postorder iteratorer*/
